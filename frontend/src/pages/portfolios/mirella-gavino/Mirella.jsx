      ...
      <main className="pt-24 container mx-auto flex-1 space-y-20 px-6 md:px-12">
        ...
        <section id="home" className="flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 space-y-6">
            ...
            <a
              href="/cv.pdf"
              className="inline-flex items-center gap-2 px-6 py-3 bg-purple-600 text-white rounded-full shadow-lg hover:bg-purple-700 transition-all"
            >
          ...
          <div className="flex-1 flex justify-center">
            <img
              src={mirella}
              alt="Anurag Gharat"
              className="rounded-full w-64 h-64 object-cover object-center shadow-2xl border-4 border-purple-600"
            />
          </div>
        </section>
